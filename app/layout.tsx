...
// Set up connectors - Multiple options
...
// Also include simple injected connector for direct MetaMask
const connectors = [injected(), ...rainbowConnectors];
